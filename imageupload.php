...
// select the db
mysqli_select_db ($conn,$db) or die ("Unable to select db".mysql_error());
 
// our sql query
 
$sql = "INSERT INTO upload (image,name,size) VALUES ('{$imgData}', '{$_FILES['image']['name']}','{$_FILES['image']['size']}');";

mysqli_query($conn,$sql) or die("Error in Query insert: " . mysql_error());
// insert the image
